...
typedef struct _sensor {
    ...
    int  (*set_framerate)       (struct _sensor *sensor, framerate_t framerate);
    ...
    int  (*set_auto_gain)       (struct _sensor *sensor, int enable, int gain);
    int  (*set_auto_exposure)   (struct _sensor *sensor, int enable, int exposure);
    int  (*set_auto_whitebal)   (struct _sensor *sensor, int enable, int r_gain, int g_gain, int b_gain);
